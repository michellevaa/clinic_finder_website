...
Clinic Finder is a web application designed to help users quickly locate the nearest clinics during emergencies. It utilizes Google Maps APIs to identify and display nearby clinics in real-time.
Whether you're in a new city or facing a critical situation, Clinic Finder ensures that help is just a click away.
...
[Visit Clinic Finder](https://hospital-finder-eta.vercel.app/)

## Features

- Detects the user’s current location
- Displays nearby clinics using the Google Maps API
